...
<section class="contentSection position-relative">
    <div class="container-fluid contentRow">
        <form action="{{ route('profileEdit') }}" method="POST" class="position-relative" style="z-index: 1" enctype="multipart/form-data">
            @csrf
            <div class="row py-5">
                <div class="col-md-3">
                    ...
                    <div class="mt-2">
                        <img id="profile-img"
                            src="{{asset('storage/images/'.($response_exists['profile_img']==null?'profile.png':$response_exists['profile_img']))}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-2" id="firstName"
                                        value="{{ $response_exists['name'] }}" name="name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-2" id="lastName"
                                        value="{{ $response_exists['last_name'] }}" name="last_name">
                                </div>
                            </div>
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control mt-2" id="email"
                                        value="{{ $response_exists['email'] }}" name="email">
                                </div>
                            </div>
                            <div class="col-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control mt-2" id="tel"
                                        value="{{ $response_exists['phone'] }}" name="phone">
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="save-btn position-relative mt-4 ml-auto d-flex align-items-center justify-content-center">Save</button>
                </div>
            </div>
        </form>
