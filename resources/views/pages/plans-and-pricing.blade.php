            ...
            <div class="col">
                <div class="plan-card basic">
                    <div class="d-flex align-items-center justify-content-between">
                        <h2 class="heading-one font-49">Basic Plan</h2>
                        <h2 class="price">
                            $500
                            <span style="font-size:16px">/month</span>
                        </h2>
                    </div>
                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mt-3 mt-md-5" style="gap:1rem;">
                        <div>
                            <div class="d-flex align-items-center" style="gap:8px;">
                                <span style="width:7px;height:7px;border-radius:50%;background:rgba(94, 94, 94, 1);"></span>
