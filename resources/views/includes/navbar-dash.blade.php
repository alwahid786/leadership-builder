    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav mr-auto sidenav pb-5" id="navAccordion">
            <div class="collapse show" id="submenu">
                <li class="nav-item plans my-1 {{ request()->is('dashboard') ? 'active' : '' }}">
                    <a class="nav-link d-flex align-items-center" style="gap:19px" href="{{url('/dashboard')}}">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect y="12.5713" width="9.42857" height="9.42857" rx="2" fill="white"/>
                            <rect x="12.5713" width="9.42857" height="9.42857" rx="2" fill="white"/>
                            <rect x="12.5713" y="12.5713" width="9.42857" height="9.42857" rx="2" fill="white"/>
                        </svg>                     
                        <span class="">Dashboard</span>
                    </a>
                </li>
                <li class="nav-item invoices my-1 {{ request()->is('invoices')||request()->is('invoices/*') ? 'active' : '' }}">
                ...
                <li class="nav-item settings my-1 {{ request()->is('users')||request()->is('user-detail/*')||request()->is('adduserpage')||request()->is('import-users-page') ? 'active' : '' }}">
                    <a class="nav-link d-flex align-items-center" style="gap:19px" href="{{url('/users')}}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M20.4002 7.19961C20.4002 9.18783 18.7884 10.7996 16.8002 10.7996C14.812 10.7996 13.2002 9.18783 13.2002 7.19961C13.2002 5.21138 14.812 3.59961 16.8002 3.59961C18.7884 3.59961 20.4002 5.21138 20.4002 7.19961Z" fill="white"/>
                            <path d="M15.5152 20.3996C15.5712 20.0077 15.6002 19.607 15.6002 19.1996C15.6002 17.2374 14.9274 15.4323 13.7999 14.0025C14.6825 13.4919 15.7072 13.1996 16.8002 13.1996C20.1139 13.1996 22.8002 15.8859 22.8002 19.1996V20.3996H15.5152Z" fill="white"/>
                            <path d="M7.2002 13.1996C10.5139 13.1996 13.2002 15.8859 13.2002 19.1996V20.3996H1.2002V19.1996C1.2002 15.8859 3.88649 13.1996 7.2002 13.1996Z" fill="white"/>
                        </svg>                            
                        <span class="">Users</span>
                    </a>
                </li>
                <li class="nav-item settings my-1 {{ request()->is('all-questions')||request()->is('add-question-page')||request()->is('edit-question-page/*')||request()->is('importpage')||request()->is('question-detail/*')||request()->is('answer/*') ? 'active' : '' }}">
                ...
                <li class="nav-item settings my-1 {{ request()->is('plans-and-pricing')||request()->is('add-plan-page')||request()->is('edit-plan-page/*') ? 'active' : '' }}">
                    <a class="nav-link d-flex align-items-center" style="gap:19px" href="{{url('/plans-and-pricing')}}">
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12.0171 0.000370845C14.4054 0.0468544 16.7599 0.338433 19.0256 1.13288C20.1542 1.5301 21.2405 2.02452 22.1494 2.82742C22.4748 3.11477 22.775 3.44438 23.0159 3.80357C23.6373 4.73747 23.6246 5.70094 23.0286 6.64752C22.5594 7.39125 21.8788 7.91525 21.1306 8.35473C19.7019 9.19566 18.1421 9.68585 16.5274 9.99011C12.5878 10.7296 8.68197 10.6324 4.83113 9.44076C3.53342 9.03931 2.29912 8.48573 1.26772 7.56874C0.9676 7.30251 0.697068 6.98981 0.468807 6.6602C-0.161024 5.73898 -0.139888 4.68253 0.481489 3.75709C0.942237 3.07674 1.56361 2.57387 2.25685 2.15552C3.66869 1.30191 5.22002 0.820172 6.82207 0.486335C8.53825 0.127144 10.2713 -0.00808071 12.0171 0.000370845Z" fill="white"/>
